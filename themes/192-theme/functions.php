 ...
 */
 ...
 // Contiene los controladores a usar en los templates en front

 include_once('functions/theme/controllers.php');

 // ---------------- ****
 // Contiene ******

 include_once('functions/theme/customize.php');

 // ---------------- formatos de posts
 // Agrega soporte al tema para escoger formatos de posts en admin

 include_once('functions/theme/formats.php');
