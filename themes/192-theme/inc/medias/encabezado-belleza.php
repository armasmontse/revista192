...
<div class="container main-container">
	<div class="row preview">
		<div class="container">
			<?php if( is_single() ): ?>
				<h1 class="belleza__ttl"><?php echo $cltvo_post->post->post_title; ?></h1>
			<?php else:?>
				<h2 class="belleza__ttl"><?php echo $cltvo_post->post->post_title; ?></h2>
			<?php endif;?>
			<h3 class="belleza__sbttl"><?php echo $cltvo_post->subtitulo;?></h3>
			<div class="tags">
