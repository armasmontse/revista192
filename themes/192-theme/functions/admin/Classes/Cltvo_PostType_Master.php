...
abstract class Cltvo_PostType_Master {
	...
	/**
	* Traduce todas las propiedades de $this->post (post papá)
	* @param $propiedades (array) nombre de las propiedades a traducir
	*/
  public function translateParent($propiedades = []){
	  foreach ($propiedades as $propiedad) {
		  $this->post->$propiedad = cltvo_translate($this->post->$propiedad);
	  }
  }
}
