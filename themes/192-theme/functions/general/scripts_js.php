...
function cltvo_js(){
	...
	wp_register_style( 'cltvo_swiper_css', CSSPATH.'swiper.css', false, true );
	wp_register_script( 'cltvo_swiper_js', JSPATH.'swiper.jquery.min.js', array('jquery'), false, true );
	wp_enqueue_style('cltvo_swiper_css');

	wp_register_script( 'cltvo_paypal_js', JSPATH.'paypal-button.min.js', array('jquery'), false, true );

	wp_register_script( 'cltvo_functions_js', JSPATH.'functions.js', array('jquery', 'cltvo_swiper_js', 'cltvo_paypal_js', 'cltvo_cltvo_js'), false, true );
	wp_localize_script( 'cltvo_functions_js', 'cltvo_js_vars', cltvo_js_vars() );

	wp_register_script( 'cltvo_cltvo_js', JSPATH.'cltvo.js', array('jquery'), false, true );

	wp_enqueue_script('jquery');
	wp_enqueue_script('cltvo_cltvo_js');
